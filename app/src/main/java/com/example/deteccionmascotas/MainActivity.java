package com.example.deteccionmascotas;
...
import com.example.deteccionmascotas.ml.ModelMascota;
...
public class MainActivity extends AppCompatActivity implements OnSuccessListener<Text>,
    ...
    public void PersonalizedModel(View v) {
        try {
            ModelMascota model = ModelMascota.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            ModelMascota.Outputs outputs = model.process(image);
